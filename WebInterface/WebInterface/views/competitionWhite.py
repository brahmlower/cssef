...
def createTeam(request, organizationUrl, competitionUrl):
	context = {}
	context['organization'] = cssefApi.getOrganization(organizationUrl)
	context['competition'] = cssefApi.getCompetition(context['organization']['organizationId'], competitionUrl)
	return render_to_response('competition/createEditTeam.html', context)

def editTeam(request, organizationUrl, competitionUrl):
	context = {}
	context['organization'] = cssefApi.getOrganization(organizationUrl)
	context['competition'] = cssefApi.getCompetition(context['organization']['organizationId'], competitionUrl)
	return render_to_response('competition/createEditTeam.html', context)
...
def createService(request, organizationUrl, competitionUrl):
	context = {}
	context['organization'] = cssefApi.getOrganization(organizationUrl)
	context['competition'] = cssefApi.getCompetition(context['organization']['organizationId'], competitionUrl)
	return render_to_response('competition/createEditService.html', context)

def editService(request, organizationUrl, competitionUrl):
	context = {}
	context['organization'] = cssefApi.getOrganization(organizationUrl)
	context['competition'] = cssefApi.getCompetition(context['organization']['organizationId'], competitionUrl)
	return render_to_response('competition/createEditService.html', context)

def listInjects(requet, organizationUrl, competitionUrl):
	context = {}
	context['organization'] = cssefApi.getOrganization(organizationUrl)
	context['competition'] = cssefApi.getCompetition(context['organization']['organizationId'], competitionUrl)
	return render_to_response('competition/listInjects.html', context)

def createInject(request, organizationUrl, competitionUrl):
	context = {}
	context['organization'] = cssefApi.getOrganization(organizationUrl)
	context['competition'] = cssefApi.getCompetition(context['organization']['organizationId'], competitionUrl)
	return render_to_response('competition/createEditInject.html', context)

def editInject(request, organizationUrl, competitionUrl):
	context = {}
	context['organization'] = cssefApi.getOrganization(organizationUrl)
	context['competition'] = cssefApi.getCompetition(context['organization']['organizationId'], competitionUrl)
	return render_to_response('competition/createEditInject.html', context)

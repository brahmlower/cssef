...
urlpatterns = patterns('',
	...
	url(r'^competitions/(?P<competition>[\w\-\_]{0,50})/injects/(?P<ijctid>[0-9][0-9]*)/$', Comp.injects_respond), # Respond to a specific inject
	...
	url(r'^competitions/(?P<competition>[\w\-\_]{0,50})/incidentresponse/(?P<intrspid>[0-9][0-9]*)/$',	Comp.incidentresponse_respond), # LOL!
	...
	url(r'^admin/servicemodules/edit/(?P<servmdulid>[0-9][0-9]*)/$',	AdminConfig.servicemodule_edit),
	url(r'^admin/servicemodules/test/(?P<servmdulid>[0-9][0-9]*)/$',	AdminConfig.servicemodule_test),	
	url(r'^admin/servicemodules/delete/(?P<servmdulid>[0-9][0-9]*)/$',	AdminConfig.servicemodule_delete),
	...
	url(r'^admin/competitions/(?P<competition>[\w\-\_]{0,50})/teams/edit/(?P<teamid>[0-9][0-9]*)/$',	CompConfig.teams_edit),
	url(r'^admin/competitions/(?P<competition>[\w\-\_]{0,50})/teams/delete/(?P<teamid>[0-9][0-9]*)/$',	CompConfig.teams_delete),
	...
	url(r'^admin/competitions/(?P<competition>[\w\-\_]{0,50})/services/edit/(?P<servid>[0-9][0-9]*)/$',		CompConfig.services_edit),
	url(r'^admin/competitions/(?P<competition>[\w\-\_]{0,50})/services/delete/(?P<servid>[0-9][0-9]*)/$',	CompConfig.services_delete),
	...
	url(r'^admin/competitions/(?P<competition>[\w\-\_]{0,50})/injects/edit/(?P<ijctid>[0-9][0-9]*)/$',		CompConfig.injects_edit),
	url(r'^admin/competitions/(?P<competition>[\w\-\_]{0,50})/injects/delete/(?P<ijctid>[0-9][0-9]*)/$',	CompConfig.injects_delete),
	url(r'^admin/competitions/(?P<competition>[\w\-\_]{0,50})/injects/create/$',							CompConfig.injects_create),
	# Uploaded file related urls
	url(r'^resources/injects/(?P<compid>[0-9][0-9]*)/(?P<ijctid>[0-9][0-9]*)/(?P<filename>[\w\-\_\.\s\#]{0,64})$',	Resources.inject),
	url(r'^resources/injectresponses/(?P<compid>[0-9][0-9]*)/(?P<teamid>[0-9][0-9]*)/(?P<ijctrespid>[0-9][0-9]*)/(?P<filename>[\w\-\_\.\s\#]{0,64})$',	Resources.injectresponse),
	url(r'^resources/incidentresponses/(?P<compid>[0-9][0-9]*)/(?P<teamid>[0-9][0-9]*)/(?P<intrspid>[0-9][0-9]*)/(?P<filename>[\w\-\_\.\s\#]{0,64})$',	Resources.incidentresponse)

...
def model_del(cls, database_connection, pkid):
    ...
    """
    # This has all been commented out for now because this is general functionality that should be applied to
    # each of the model actions, and therefore should be refactored to be used by each of the model action functions
    # if pkid == "*":
